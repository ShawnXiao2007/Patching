		...
		for(block_iter=blocks.begin();block_iter!=blocks.end();++block_iter)
		{
			...
			if(entry_point!=NULL)
			{
				...
				BPatch_arithExpr log_s=BPatch_arithExpr(BPatch_seq,
							BPatch_arithExpr(BPatch_assign,BPatch_arithExpr(BPatch_plus,*basePtr,/**index*/BPatch_constExpr(0)),*idsnippet),
							BPatch_arithExpr(BPatch_assign,*basePtr/**index*/,BPatch_arithExpr(BPatch_plus,*basePtr/**index*/,BPatch_constExpr(0)))
								);
                                BPatch_arithExpr log_direct=BPatch_arithExpr(BPatch_seq,
                                                        BPatch_arithExpr(BPatch_assign,*basePtr,*idsnippet),
                                                        BPatch_arithExpr(BPatch_assign,*basePtr/**index*/,BPatch_arithExpr(BPatch_plus,*basePtr/**index*/,BPatch_constExpr(0)))
                                                                );
				binedit->insertSnippet(log_direct,*entry_point);	
				//binedit->insertSnippet(printfCall3,*entry_point);		
			}
		}
	}
